  ...
  return (
    ...
    >
      ...
      <div className="flex items-center" style={{ WebkitAppRegion: 'no-drag' as any }}>
        <button className="h-full px-3 py-2 text-text-tertiary hover:text-foreground hover:bg-surface-2 transition-colors">
          <Minus size={14} />
        </button>
        <button className="h-full px-3 py-2 text-text-tertiary hover:text-foreground hover:bg-surface-2 transition-colors">
          <Square size={12} />
        </button>
        <button className="h-full px-3 py-2 text-text-tertiary hover:text-foreground hover:bg-accent-red transition-colors">
          <X size={14} />
        </button>
      </div>
    </div>
