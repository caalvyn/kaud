...
You have context about the user's project and can help with:
...
- Best practices`,
    ...
    if (!response.ok) {
      ...
      if (response.status === 402) {
        return new Response(
          JSON.stringify({ error: "AI usage credits exhausted. Please add credits in your Lovable workspace settings." }),
